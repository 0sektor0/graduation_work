%тест для проверки функций определений особых состояний.
%в первом временном ряду присутствуют все возможные типы стандартных особых
%состояний, а во втором особые состояния отсутствуют
%в случае нахождения особого состояния выводится позиция элемента с
%которого оно начинается и флаг присутствия состояния
